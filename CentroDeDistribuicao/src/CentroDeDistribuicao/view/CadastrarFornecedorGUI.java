...
public class CadastrarFornecedorGUI extends JFrame{
    ...
    public CadastrarFornecedorGUI() throws HeadlessException {
    ...
    private void iniciarBotoes() {
        this.b1 = new JButton("Cadastrar Fornecedor");
        this.panel.get(18).add(this.b1);
    ...
    private void iniciarCampoTexto() {
        ...
        this.panel.get(3).add(txtEmail);
        this.panel.get(5).add(txtTelefone);
        this.panel.get(7).add(txtCep);
        this.panel.get(9).add(txtLogradouro);
        this.panel.get(11).add(txtNumero);
        this.panel.get(13).add(txtBairro);
        this.panel.get(15).add(txtCidade);
        this.panel.get(17).add(txtUf);
    }
}
